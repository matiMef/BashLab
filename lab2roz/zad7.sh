...
plik_wynikowy="ddd/ostrzeżenie"

# Tworzymy plik ostrzeżenia i wpisujemy pierwszą linię
echo "Uważaj na te pliki:" > "$plik_wynikowy"

# Szukamy plików, które są zwyczajne i wykonywalne
for plik in bbb/**/*; do 
...
echo "Skanowanie zakończone. Lista plików zapisano w $plik_wynikowy"

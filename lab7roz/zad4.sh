...
# Liczba wszystkich linii
total_lines=$(wc -l < dodatkowe/slajdy.tex)

# Liczba niepustych linii (ignorujemy linie zawierające tylko spacje/tabulatory)
non_empty_lines=$(grep -cve '^[[:space:]]*$' dodatkowe/slajdy.tex)

# Wyświetlenie wyniku jako ułamek X/Y
echo "$non_empty_lines/$total_lines"
